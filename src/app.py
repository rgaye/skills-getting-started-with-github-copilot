...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer practice and seasonal matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and water fitness for all skill levels",
    ...
    "Art Workshop": {
        ...
        "max_participants": 15,
        "participants": ["lily@mergington.edu", "isabella@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Olympiad": {
        "description": "Compete in science challenges and hands-on engineering events",
